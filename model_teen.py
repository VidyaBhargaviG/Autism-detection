...
#df = df.drop(columns=["id", "age_desc", "contry_of_res", "relation", "result", "used_app_before"], errors='ignore')

label_encoders = {}
for col in df.columns:
    if df[col].dtype == 'object' and col != "Class":  # Exclude "Class" from encoding
        le = LabelEncoder()
...
# Use class_encoder to decode the prediction
